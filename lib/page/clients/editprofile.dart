...
class EditProfile extends StatefulWidget {
  final client;
  const EditProfile({this.client,super.key});
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                            ...
                            autofocus: true,
                            decoration: sheet.logindeco(widget.client['name'], "Name")),
                      ),
                      GestureDetector(
                        onTap: () {
                  ...
                  Container(
                    ...
                    child: TextField(
                        ...
                        cursorColor: col.whites,
                        decoration:
                            sheet.logindeco(widget.client['email'], "Email")),
                  ),
                  SizedBox(
                    height: 2.h,
                  ),
                  Container(
                    ...
                    child: TextField(
                        ...
                        controller: phone,
                        cursorColor: col.whites,
                        decoration: sheet.logindeco(widget.client['phone'], "Phone")),
                  ),
                  SizedBox(
                    height: 2.h,
                  ),
                  Container(
                      ...
                      child: ListCountryPiker(
                        ...
                        child: ListTile(
                          title: Text(
                            _country==null? widget.client['country']:_country.toString(),
...
/************************* */
  ...
  addToDb() async {
   ...
   var url = Uri.parse('https://invogen.cosmeticplugs.com/api/client/update');
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      ...
      sheet.showSucessTost(context, "Client update Successfuly");
clearAll();
    } else {
